...
<br /><br />
Minha trajetória inclui a criação de projetos pessoais, como portfólios, dashboards, sites, APIs e blogs, utilizando tecnologias como, Docker, ReactJS, Styled Components, Pocketbase, TailwindCSS, ShadcnUI, CMS, e APIs desenvolvidas com NodeJS, FastifyJS, Prisma etc. Além disso, tive a oportunidade de ministrar, junto com meus colegas, um minicurso de Introdução a Algoritmos em JavaScript, no qual também desenvolvemos um jogo chamado Memory Game, disponível no <a href="https://www.youtube.com/watch?v=h5i7P6rqAhU&t=5s" aria-label="link para o vídeo no youtube" target="_blank">YouTube</a>.
<br /><br />
...
<br /><br />
Estou focado em alcançar meus objetivos acadêmicos e profissionais e, junto com meus colegas, busco constantemente oportunidades para formar grupos de estudo e desenvolver projetos para diversos tipos de negócios como freelancer.`;
